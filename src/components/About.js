        ...
        <div className="container">
          ...
          <div className="categories-grid">
            <div className="category-card">
              ...
              <h3>Binding Tapes</h3>
              <p>Premium cotton binding tapes for garment finishing and craft projects</p>
            </div>
            <div className="category-card">
              <div className="category-icon">🕯️</div>
              <h3>Cotton Wicks</h3>
              <p>Pure cotton wicks for oil lamps, diyas, and spiritual purposes</p>
            </div>
            <div className="category-card">
            ...
            <div className="category-card">
              <div className="category-icon">📐</div>
              <h3>Twill Tapes</h3>
              <p>Strong twill weave tapes ideal for reinforcement and heavy-duty use</p>
            </div>
            <div className="category-card">
              <div className="category-icon">〰️</div>
              <h3>Herringbone Tapes</h3>
              <p>Premium herringbone pattern tapes for decorative applications</p>
            </div>
            <div className="category-card">
              <div className="category-icon">🧶</div>
              <h3>Fabric Tapes</h3>
              <p>Versatile fabric tapes for binding, trimming, and decorative purposes</p>
            </div>
          </div>
        </div>
      </div>
